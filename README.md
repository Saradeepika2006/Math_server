...
{% csrf_token %}
<div class="formelt">
intensity : <input type="text" name="intensity" value="{{i}}"></input>(i
</div>
<div class="formelt">
resistance : <input type="text" name="resistance" value="{{r}}"></input>
</div>
<div class="formelt">
<input type="submit" value="Calculate"></input><br/>
</div>
<div class="formelt">
Power : <input type="text" name="power" value="{{power}}"></input>(in W)
</div>
</form>
</div>
</div>
...
![EX 5 web](https://github.com/user-attachments/assets/d0adf0ae-30e4-4b47-a7de-b491a8e2daa7)

# HOMEPAGE:
![EX 5 HOME](https://github.com/user-attachments/assets/cb6d5180-a632-4cd1-af10-646121f85e54)
